  ...
  return (
    <div className="p-2 space-y-12">
      <div className="px-2 max-w-5xl mx-auto">
        ...
        {/* Section 1 */}
        <div className="mb-12">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">{t('PROGRAM_MODAL_SHORT_TERM_SUBTITLE_1')}</h2>
        ...
        {/* Section 2 */}
        <div className="mb-12">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">{t('PROGRAM_MODAL_SHORT_TERM_SUBTITLE_2')}</h2>
        ...
        {/* Section 3 */}
        <div className="mb-12">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">{t('PROGRAM_MODAL_SHORT_TERM_SUBTITLE_3')}</h2>
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="w-full md:w-7/10">
              <p className="text-gray-700 leading-relaxed">
        ...
        {/* Section 4 */}
        <div className="mb-16">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">{t('PROGRAM_MODAL_SHORT_TERM_SUBTITLE_4')}</h2>
          <div className="flex flex-col md:flex-row-reverse items-start gap-6">
            <div className="w-full md:w-7/10">
            ...
            <table className="min-w-full bg-white text-base rounded-xl overflow-hidden text-gray-700">
              ...
              <tbody>
                <tr className="border-b border-[#e9d5e1]">
                  ...
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_1')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_1')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_2')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_2')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_2')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_3')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_3')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_3')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_4')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_4')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_4')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_5')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_5')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_5')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_6')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_6')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_6')}</td>
                </tr>
                <tr className="border-b border-[#e9d5e1]">
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_7')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_7')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_7')}</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 text-center bg-[#f9f5f7]">{t('PROGRAM_MODAL_TABLE_SECTION_8')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_1_8')}</td>
                  <td className="py-2 px-4 text-center">{t('PROGRAM_MODAL_SHORT_TERM_TABLE_VALUE_2_8')}</td>
                </tr>
              </tbody>
            </table>
          </div>
